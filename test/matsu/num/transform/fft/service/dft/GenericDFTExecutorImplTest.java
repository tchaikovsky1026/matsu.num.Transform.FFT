...
public class GenericDFTExecutorImplTest {

    public static final Class<?> TEST_CLASS = GenericDFTExecutorImpl.class;
    private static final GenericDFTExecutor EXECUTOR_NEW = new GenericDFTExecutorImpl(CommonLib.defaultImplemented());
    ...
    public static class DFTの実行を検証 {
        ...
        @DataPoint
        public static final DFTExecutor executorCall =
                FFTModuleExecutorProvider.byDefaultLib().get(ExecutorTypes.DFT.GENERIC_DFT_EXECUTOR);
