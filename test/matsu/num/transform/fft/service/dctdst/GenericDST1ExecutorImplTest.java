...
import matsu.num.transform.fft.dctdst.DST1Moch;
...
public class GenericDST1ExecutorImplTest {
    ...
    private static final GenericDST1ExecutorImpl EXECUTOR_NEW =
            new GenericDST1ExecutorImpl(CommonLib.defaultImplemented());
    ...
    public static class DST1検証 {

        @DataPoint
        public static final DST1Executor executorNew = EXECUTOR_NEW;

        @DataPoint
        public static final DST1Executor executorCall =
                FFTModuleExecutorProvider.byDefaultLib().get(ExecutorTypes.DCTDST.GENERIC_DST1_EXECUTOR);
        ...
        @Theory
        public void test_DST1の実行(DST1Executor executor, double[] data) {
