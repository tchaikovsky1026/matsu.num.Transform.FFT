...
/**
 * {@link GenericDCT2ExecutorImpl}クラスのテスト.
 * 
 * @author Matsuura Y.
 */
@RunWith(Enclosed.class)
public class GenericDCT2ExecutorImplTest {

    public static final Class<?> TEST_CLASS = GenericDCT2ExecutorImpl.class;
    private static final GenericDCT2ExecutorImpl EXECUTOR_NEW =
            new GenericDCT2ExecutorImpl(CommonLib.defaultImplemented());
    ...
    public static class DCT2検証 {
        ...
        @DataPoint
        public static final DCT2Executor executorCall =
                FFTModuleExecutorProvider.byDefaultLib().get(ExecutorTypes.DCTDST.GENERIC_DCT2_EXECUTOR);
