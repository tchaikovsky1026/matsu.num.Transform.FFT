...
public class GenericDST4ExecutorImplTest {
    ...
    private static final GenericDST4ExecutorImpl EXECUTOR_NEW =
            new GenericDST4ExecutorImpl(CommonLib.defaultImplemented());
    ...
    public static class DST4検証 {
        ...
        @DataPoint
        public static final DST4Executor executorCall =
                FFTModuleExecutorProvider.byDefaultLib().get(ExecutorTypes.DCTDST.GENERIC_DST4_EXECUTOR);
