...
public class GenericDCT4ExecutorImplTest {
    ...
    private static final GenericDCT4ExecutorImpl EXECUTOR_NEW =
            new GenericDCT4ExecutorImpl(CommonLib.defaultImplemented());
    ...
    public static class DCT4検証 {
        ...
        @DataPoint
        public static final DCT4Executor executorCall =
                FFTModuleExecutorProvider.byDefaultLib().get(ExecutorTypes.DCTDST.GENERIC_DCT4_EXECUTOR);
