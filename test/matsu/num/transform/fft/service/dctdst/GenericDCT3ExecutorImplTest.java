...
import matsu.num.transform.fft.dctdst.DCT3Moch;
...
/**
 * {@link GenericDCT3ExecutorImpl}クラスのテスト.
 * 
 * @author Matsuura Y.
 */
@RunWith(Enclosed.class)
public class GenericDCT3ExecutorImplTest {

    public static final Class<?> TEST_CLASS = GenericDCT3ExecutorImpl.class;
    private static final GenericDCT3ExecutorImpl EXECUTOR_NEW =
            new GenericDCT3ExecutorImpl(CommonLib.defaultImplemented());
    ...
    public static class DCT3検証 {

        @DataPoint
        public static final DCT3Executor executorNew = EXECUTOR_NEW;

        @DataPoint
        public static final DCT3Executor executorCall =
                FFTModuleExecutorProvider.byDefaultLib().get(ExecutorTypes.DCTDST.GENERIC_DCT3_EXECUTOR);
        ...
        @Theory
        public void test_DCT3の実行(DCT3Executor executor, double[] data) {
            double[] result = executor.apply(data);
            double[] expected = new DCT3Moch().apply(data);
