...
public class GenericDCT2ExecutorTest {
    ...
    public static class 入力サイズの検証 {
        ...
        public void test_入力サイズが0でIAEx() {
            GenericDCT2Executor.instance().apply(new double[0]);
        }

        @Test(expected = None.class)
        public void test_入力サイズが1で正常() {
            GenericDCT2Executor.instance().apply(new double[1]);
        }
    }

    public static class DCT2検証_サイズ99 {
        ...
        @Test
        public void test_DCT2の実行() {
            double[] result = GenericDCT2Executor.instance().apply(data);
    ...
    public static class toString表示の検証 {
        ...
        public void test_toString表示() {
            ...
            System.out.println(GenericDCT2Executor.instance());
            System.out.println();
        }
    }
