...
public class GenericDCT4ExecutorTest {
    ...
    public static class 入力サイズの検証 {
        ...
        public void test_入力サイズが0でIAEx() {
            GenericDCT4Executor.instance().apply(new double[0]);
        }

        @Test(expected = None.class)
        public void test_入力サイズが1で正常() {
            GenericDCT4Executor.instance().apply(new double[1]);
        }
    }

    public static class DCT4検証_サイズ99 {
        ...
        @Test
        public void test_DCT4の実行() {
            double[] result = GenericDCT4Executor.instance().apply(data);
    ...
    public static class toString表示の検証 {
        ...
        public void test_toString表示() {
            ...
            System.out.println(GenericDCT4Executor.instance());
            System.out.println();
        }
    }
