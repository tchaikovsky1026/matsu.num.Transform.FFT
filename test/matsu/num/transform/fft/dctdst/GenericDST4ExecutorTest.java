...
public class GenericDST4ExecutorTest {
    ...
    public static class 入力サイズの検証 {
        ...
        public void test_入力サイズが0でIAEx() {
            GenericDST4Executor.instance().apply(new double[0]);
        }

        @Test(expected = None.class)
        public void test_入力サイズが1で正常() {
            GenericDST4Executor.instance().apply(new double[1]);
        }
    }

    public static class DST4検証_サイズ99 {
        ...
        @Test
        public void test_DST4の実行() {
            double[] result = GenericDST4Executor.instance().apply(data);
    ...
    public static class toString表示の検証 {
        ...
        public void test_toString表示() {
            ...
            System.out.println(GenericDST4Executor.instance());
            System.out.println();
        }
    }
