...
public class GenericDCT3ExecutorTest {
    ...
    public static class DCT3検証_サイズ99 {
        ...
        @Test
        public void test_DCT3の実行() {
            double[] result = GenericDCT3Executor.instance().apply(data);
    ...
    public static class toString表示の検証 {
        ...
        public void test_toString表示() {
            ...
            System.out.println(GenericDCT3Executor.instance());
            System.out.println();
        }
    }
