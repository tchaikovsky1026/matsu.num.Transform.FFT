...
public class GenericDFTExecutorTest {
    ...
    public static class 入力サイズの検証 {
        ...
        public void test_入力サイズが0でIAEx() {
            GenericDFTExecutor.instance().apply(ComplexNumberArrayDTO.zeroFilledOf(0));
        }

        @Test(expected = None.class)
        public void test_入力サイズが1で正常() {
            GenericDFTExecutor.instance().apply(ComplexNumberArrayDTO.zeroFilledOf(1));
        }
    }

    public static class DFTの実行を検証_サイズ100 {
        ...
        @Test
        public void test_DFTの実行() {
            FourierBasisComputer basisComputer = FourierBasisComputer.covering(data.length, FourierType.DFT);
            ComplexNumberArrayDTO resultDto = GenericDFTExecutor.instance().apply(dataArrayDto);
    ...
    public static class toString表示の検証 {
        ...
        public void test_toString表示() {
            ...
            System.out.println(GenericDFTExecutor.instance());
            System.out.println();
        }
    }
