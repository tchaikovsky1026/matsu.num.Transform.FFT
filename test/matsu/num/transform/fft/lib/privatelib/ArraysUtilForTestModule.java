 ...
 */
@Ignore
public final class ArraysUtilForTestModule {

    private ArraysUtilForTestModule() {
        //インスタンス化不可
    ...
    public static final double[] normalizeEuclidean(double[] vector) {
        ...
        if (normMax < 1E-280) {
            ArraysUtilForTestModule.multiply(canoVector, 1E200);
        }
        if (normMax > 1E280) {
            ArraysUtilForTestModule.multiply(canoVector, 1E-200);
        }

        double canoNorm2 = ArraysUtilForTestModule.norm2(canoVector);
        ArraysUtilForTestModule.multiply(canoVector, 1 / canoNorm2);
        return canoVector;
    }
}
