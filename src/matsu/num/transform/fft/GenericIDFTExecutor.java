 ...
 * 
 * <p>
 * {@linkplain IDFTExecutor#apply(ComplexNumberArrayDTO)} メソッドで追加でスローされる条件は次のとおりである.
 * </p>
 * 
 * <ul>
...
public final class GenericIDFTExecutor {
    ...
    private static final class IDFTExecutorImpl implements IDFTExecutor {

        private static final String CLASS_STRING = "Generic-IDFT";

        private static final FourierType TYPE = FourierType.IDFT;

        private final ComplexNumbersLinearBijectiveTransform idft =
                ScalingComplexNumberTransform.decorate(new NonScalingIDFT());
        ...
        public ComplexNumberArrayDTO apply(ComplexNumberArrayDTO complexNumberArrayDto) {
            ...
            return this.idft.apply(complexNumberArrayDto);
        }
        ...
        /**
         * スケーリング, 事前条件チェック, 防御的コピーのないIDFT.
         */
        private static final class NonScalingIDFT implements IDFTExecutor {
