 ...
 * @author Matsuura Y.
 * @version 12.1
 * @deprecated このモジュール内では線形変換しか扱わないので, {@link RealNumbersLinearBijectiveTransform}を使用するように. version 13以降で削除
 * @see RealNumbersLinearBijectiveTransform
 */
@Deprecated(forRemoval = true)
public interface RealNumbersBijectiveTransform {
