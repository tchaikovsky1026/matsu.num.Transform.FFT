 ...
 * <i>x</i><sub><i>j</i></sub>
 * sin[<i>&pi;</i> (<i>j</i> + (1/2)) (<i>k</i> + (1/2)) / <i>N</i>].
 * </p>
 * 
 * <p>
 * このインターフェースでは,
 ...
 * 
 * <i>X</i><sub><i>k</i></sub> = (i / 2) exp[-i<i>&pi;</i><i>k</i> / (2<i>N</i>)]
 ...
 * @author Matsuura Y.
 */
public interface DST4Executor extends LinearTransform {
