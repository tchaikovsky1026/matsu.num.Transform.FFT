 ...
 * <i>X</i><sub><i>k</i></sub> = &Sigma;<sub><i>j</i> = 0</sub><sup><i>N</i> - 1</sup>
 * <i>x</i><sub><i>j</i></sub>
 * sin[&pi;(<i>j</i> + (1/2))(<i>k</i> + (1/2))/<i>N</i>].
 * </p>
 * 
 * 
 * <p>
 ...
 * 
 * <i>X</i><sub><i>k</i></sub> = (i/2) exp[-i&pi;<i>k</i>/(2<i>N</i>)]
 ...
 * @version 12.4
 */
public interface DST4Executor extends RealNumbersLinearBijectiveTransform {
