 ...
 * <i>x</i><sub><i>j</i></sub> sin[&pi;(<i>j</i> + 1)(<i>k</i> + 1)/(<i>N</i> + 1)].
 * </p>
 * 
 * <p>
 ...
 * DFTを行うための標本サイズ 2<i>N</i> + 2 の実数列 <i>a</i><sub><i>j</i></sub> (<i>j</i> = 0, ... , 2<i>N</i> + 1) を用意し, <br>
 * 
 ...
 * @version 12.4
 */
public interface DST1Executor extends RealNumbersLinearBijectiveTransform {
