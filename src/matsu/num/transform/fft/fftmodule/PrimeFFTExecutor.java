 ...
 * 
 * <p>
 * このクラスが提供する{@linkplain InnerDFTExecutor#compute(ComplexNumber[], FourierBasisComputer)}の事前条件(引数の条件)は以下である. 
 * </p>
 * 
 * <p>
 ...
 * これの不完全な検証として, 標本サイズが3以上の奇数でない場合は{@linkplain IllegalArgumentException}をスローする. <br>
 ...
 * @version 12.5
 */
public final class PrimeFFTExecutor {
    ...
    static {
        MAX_DATA_SIZE = CyclicConvolutionModule.MAX_SEQUENCE_SIZE;
    }

    private static final InnerDFTExecutor INSTANCE = new PrimeFFTImpl();

    private PrimeFFTExecutor() {
    ...
    private static final class PrimeFFTImpl implements InnerDFTExecutor {

        private final CyclicConvolutionModule cyclicConvolution = CyclicConvolutionModule.instance();
